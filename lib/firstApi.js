     ...
     if (posts.length === 0) { 
      ...
      const result = sortedPosts.map(post => {
        return {
          ...
          found: true,
          result: { 
            artist: post.tags.artist || "No Data",  
            species: post.tags.species || "No Data", 
            character: post.tags.character || "No Data", 
            copyright: post.tags.copyright || "No Data",
            lore: post.tags.lore || "No Data",
            meta: post.tags.meta || "No Data",
            score: post.score, 
            rating: post.rating,
            ...
            duration: toHHMMSS(Math.floor(post.duration)) || "No Data",
