...
async function yiff(tags, username, apikey) {
    ...
    try {
      ...
      if (!apikey) {
        reject({
          author: "RizzyFuzz",
          found: false,
          message: `Apikey e621.net Required! >:3`,
        });
      }
      ...
      const result = sortedPosts.map((post) => {
        return {
          ...
          metadata: {
            ...
            static: {
              md5: post.file.md5,
              url: `https://e621.cyclic.app/api/getMedia?url=https://static1.e621.net/data/${post.file.md5.slice(
                0,
                2
              )}/${post.file.md5.slice(2, 4)}/${post.file.md5}.${
                post.file.ext
              }`,
